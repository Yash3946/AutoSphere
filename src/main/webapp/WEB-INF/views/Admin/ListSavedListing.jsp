					...
					<tbody>
						...
						<c:forEach items="${allSaved}" var="s">
							<tr>
								...
								<td><a href="viewSavedListing?wishlistId=${s.wishlistId}"
									class="btn btn-sm btn-theme"> View </a> <a
									href="deleteSavedListing?wishlistId=${s.wishlistId}"
									class="btn btn-sm btn-delete"
									onclick="return confirm('Are you sure?')"> Delete </a> <a
									href="editSavedListing?wishlistId=${s.wishlistId}"
